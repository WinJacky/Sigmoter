...
public class NotificationTest {
    ...
    public void sampleTest() {
        ...
        driver.findElementById("com.mobilefootie.wc2010:id/txtNotifications").click();
        driver.findElementById("com.mobilefootie.wc2010:id/txtBreaking").click();
        driver.findElementById("com.mobilefootie.wc2010:id/txtTransfer").click();
    }
