...
// From V7.9.0
// Mine -> (setting) -> Switch night mode automatically -> Reading Settings -> Click screen to turn pages
public class ReadSettingTest {
    ...
    public void sampleTest() {
        ...
        driver.findElementById("com.zhangyue.read:id/home_user_center_setting_icon").click();
