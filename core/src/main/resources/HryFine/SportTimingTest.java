...
// From V2.1.5
// (Sport) -> Walking -> time out -> End -> End
public class SportTimingTest {
    ...
    public void sampleTest() {
        ...
        driver.findElementById("com.lianhezhuli.hyfit:id/sport_end_tv").click();
        driver.findElementByXPath("//hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.LinearLayout/android.widget.Button[1]").click();
    }
