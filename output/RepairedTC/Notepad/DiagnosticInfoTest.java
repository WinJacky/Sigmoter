...
public class DiagnosticInfoTest {
    ...
    public void sampleTest() {
        ...
        driver.findElementByXPath("//android.widget.TextView[@text=\"Attach diagnostic info\"]").click();
        driver.findElementByXPath("//android.widget.TextView[@text=\"Hide note titles in diagnostic log\"]").click();
    }
